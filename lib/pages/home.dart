  ...
  AppBar appBar() {
    return AppBar(
      ...
      leading: GestureDetector(
        onTap: () {},
        child: Container(
          margin: const EdgeInsets.all(10), // Mengatur margin sekitar ikon
          alignment: Alignment.center,
          decoration: BoxDecoration(
            color:
                const Color(0xffF7F8F8), // Mengatur warna latar belakang ikon
            borderRadius:
                BorderRadius.circular(10), // Mengatur radius sudut ikon
          ),
          child: SvgPicture.asset(
      ...
      actions: [
        GestureDetector(
          ...
          child: Container(
            margin: const EdgeInsets.all(10), // Mengatur margin sekitar ikon
            alignment: Alignment.center, // Mengatur posisi ikon di tengah
            width: 37, // Mengatur lebar ikon
            decoration: BoxDecoration(
              color:
                  const Color(0xffF7F8F8), // Mengatur warna latar belakang ikon
              borderRadius:
